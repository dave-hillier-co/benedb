...
| S4    | `tests/Spiceport.Grains.Tests/AuthzedExperimentalV1ServiceTests.cs`                  | `packages/api/src/authzed-experimental-v1-service-tests.test.ts`                     |
| S4    | `tests/Spiceport.Grains.Tests/AuthzedPermissionsV1ServiceTests.cs`                   | `packages/api/src/authzed-permissions-v1-service-tests.test.ts`                      |
| S4    | `tests/Spiceport.Grains.Tests/AuthzedSchemaV1ServiceTests.cs`                        | `packages/api/src/authzed-schema-v1-service-tests.test.ts`                           |
| S4    | `tests/Spiceport.Grains.Tests/AuthzedWatchV1ServiceTests.cs`                         | `packages/api/src/authzed-watch-v1-service-tests.test.ts`                            |
| S4    | `tests/Spiceport.Grains.Tests/BatchCheckGrpcServiceTests.cs`                         | `packages/api/src/batch-check-grpc-service-tests.test.ts`                            |
| S4    | `tests/Spiceport.Grains.Tests/BatchCheckMeshTests.cs`                                | `packages/grains/src/batch-check-mesh-tests.test.ts`                                 |
| S4    | `tests/Spiceport.Grains.Tests/BulkGrpcServiceTests.cs`                               | `packages/api/src/bulk-grpc-service-tests.test.ts`                                   |
...
| S4    | `tests/Spiceport.Grains.Tests/ConsistencyMeshTests.cs`                               | `packages/api/src/consistency-mesh-tests.test.ts`                                    |
...
| S4    | `tests/Spiceport.Grains.Tests/DataPlaneGrpcServiceTests.cs`                          | `packages/api/src/data-plane-grpc-service-tests.test.ts`                             |
...
| S4    | `tests/Spiceport.Grains.Tests/ReverseOpsGrpcServiceTests.cs`                         | `packages/api/src/reverse-ops-grpc-service-tests.test.ts`                            |
...
| S4    | `tests/Spiceport.Grains.Tests/SchemaAtRevisionMeshTests.cs`                          | `packages/api/src/schema-at-revision-mesh-tests.test.ts`                             |
...
| S4    | `tests/Spiceport.Grains.Tests/WatchGrpcServiceTests.cs`                              | `packages/api/src/watch-grpc-service-tests.test.ts`                                  |
| S4    | `tests/Spiceport.Grains.Tests/WatchGrpcServiceTests.cs`                              | `packages/api/src/collecting-stream-writer.ts`                                       |
| S4    | `tests/Spiceport.Grains.Tests/WriteSafetyGrpcServiceTests.cs`                        | `packages/api/src/write-safety-grpc-service-tests.test.ts`                           |
